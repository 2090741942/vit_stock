...
def main():
    parser = argparse.ArgumentParser(description="Run test inference and export prediction CSV.")
...
python infer_test.py \
  ...
  --checkpoint /workspace/exp_I60_R5_vitb_in21k/best.pt \
  --horizon_idx 0 \
  --batch_size 128 \
  --num_workers 12 \
  --patch_size 16 \
  --repeat_to_3ch \
  --out_csv /workspace/predict/preds_I60_R5.csv
"""